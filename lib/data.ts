...
export interface ProvinceData {
  ...
  // Harga
  currentPrice: number        // harga aktual minggu ini (historicalPrices[terakhir])
  predictedPrice: number      // prediksi 12 minggu ke depan (prediksi_12minggu[11])
  prediksi12Minggu: number[]  // array 12 titik prediksi t+1..t+12 untuk grafik
  historicalPrices: number[]   // 2 titik historis aktual, titik terakhir = harga saat ini (t)
